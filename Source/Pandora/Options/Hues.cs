...
namespace TheBox.Options
{
	...
	public class HuesOptions
	{
		...
		/// </summary>
		public Art Art { get { return m_PreviewArt; } set { m_PreviewArt = value; } }

		/// <summary>
		///     Gets or sets the index of the previewed art
		/// </summary>
		public int PreviewIndex { get { return m_PreviewIndex; } set { m_PreviewIndex = value; } }
		...
		/// </summary>
		public RecentIntList RecentHues { get { return m_RecentHues; } set { m_RecentHues = value; } }
